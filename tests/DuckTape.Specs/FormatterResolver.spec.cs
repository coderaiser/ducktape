...
Run("formatter_resolver: honors the stream", t =>
{
...
Run("formatter_base: bare formatter returns null for every hook", t =>
{
    var sw = new StringWriter();
...
Run("formatter_base: default stream is console", t =>
{
